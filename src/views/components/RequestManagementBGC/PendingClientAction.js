            ...
            <div className='low-space-table'>
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: 'Pending with', field: 'status', },
                        { title: 'Pending Information', field: 'pending_information' },
                        { title: 'Verification Specialist', field: 'verification_specialist' },
                        { title: 'Action', field: 'Action', }
                    ]}
                    data={[
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Standard", package_sla: "5 Days", check: "Education", check_sla: "2", check_tat: "1", status: 1, pending_information: "Faith Awuor", verification_specialist: "Diana Kwa", row_span: "3" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Employment", check_sla: "2", check_tat: "1", status: 2, pending_information: "Faith Awuor", verification_specialist: "Diana Kwa", col_none: "1" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Standard", package_sla: "5 Days", check: "Criminal", check_sla: "2", check_tat: "1", status: 2, pending_information: "Faith Awuor", verification_specialist: "Diana Kwa", col_none: "1" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Identity", check_sla: "2", check_tat: "1", status: 1, pending_information: "Faith Awuor", verification_specialist: "Diana Kwa", },
                    ]}
                    components={{
                        Row: ({ data }) => {
                            return (
                                <tr>
                                    ...
                                    <td>
                                        {
                                            data.status === 1 ? <span className="badge badge-purple">Client</span> :
                                                data.status === 2 ? <span className="badge badge-pink">Candidate</span> : null
                                        }
                                    </td>
                                    <td>{data.pending_information}</td>
...
export default PendingClientAction;