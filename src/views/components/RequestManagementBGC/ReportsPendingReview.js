            ...
            <div className='low-space-table'>
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: 'Review SLA', field: 'review_sla' },
                        { title: 'Review TAT', field: 'review_tat' },
                        { title: 'Reviewer', field: 'reviewer' },
                        { title: 'Action', field: 'Action', }
                    ]}
                    data={[
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Identity", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", review_sla: "3", review_tat: "4", reviewer: "Diana Kwa", row_span: "3" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Standard", package_sla: "5 Days", check: "Education", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", review_sla: "3", review_tat: "4", reviewer: "Diana Kwa", col_none: "1" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Employment", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", review_sla: "3", review_tat: "4", reviewer: "Diana Kwa", col_none: "1" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Standard", package_sla: "5 Days", check: "Criminal", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", review_sla: "3", review_tat: "4", reviewer: "Diana Kwa", },
                    ]}
                    components={{
                        Row: ({ data }) => {
                            return (
                                <tr>
                                    ...
                                    <td>{data.review_sla}</td>
                                    <td>{data.review_tat}</td>
                                    <td>{data.reviewer}</td>
                                    <td>
...
export default ReportsPendingReview;