        ...
        <>
            <div className='low-space-table'>
                <MaterialTable
                    ...
                    data={[
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Standard", package_sla: "5 Days", check: "Education", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", reviewer: "Diana Kwa", row_span: "3" },
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Employment", check_sla: "2", check_tat: "1", status: 2, verification_specialist: "Faith Awuor", reviewer: "Diana Kwa", col_none: "1" },
                        ...
                        { ref: "PIL001A", client: "Altima", requestor: "Desiree Edwards", date_requested: "13 Jun 2021", candidate_name: "Nola Lily", country: "/images/flag1.png", package: "Entry", package_sla: "5 Days", check: "Address", check_sla: "2", check_tat: "1", status: 1, verification_specialist: "Faith Awuor", reviewer: "Diana Kwa", },
                    ]}
                    components={{
                        Row: ({ data }) => {
                            return (
                                <tr>
                                    ...
                                    <td>
                                        {
                                            data.status === 1 ? <span className="badge badge-purple">Interim</span> :
                                                data.status === 2 ? <span className="badge badge-primary">Not Started</span> :
                                                    data.status === 3 ? <span className="badge badge-warning">In progress</span> : null
                                        }
                                    </td>
...
export default RequestsNearingTAT;