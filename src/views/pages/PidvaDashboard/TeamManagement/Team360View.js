	...
	return (
		<>
			<section className='dashboard-section pidvaDashboard'>
				<h1 className='dashboard-title'>Team 360 View</h1>
				<div className='row'>
					...
					<div className='col-lg-4 d-flex'>
						<div className='repeat-white-bx'>
							<div className='clientDetails'>
								...
								<div className='row'>
									<div className='col-lg-12'>
										<h4 className='d-flex justify-content-between'>Team UserName <span className='badge badge-success'>Active</span></h4>
										<p>0712 345 671</p>
									</div>
									<div className='col-lg-12'>
