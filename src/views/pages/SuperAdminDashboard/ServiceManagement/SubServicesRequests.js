	...
	return (
		<>
			<section className='dashboard-section pidvaDashboard'>
				<h1 className='dashboard-title'>Sub Service Requests</h1>

				<MaterialTable
					title="Sub Service Requests"
					columns={[
						...
						{ title: 'Document/ data Required', field: 'document_data_required' },
						{
							...
							render: (rowData) => {
								return (
									<Dropdown className='tableActionDropdown'>
										...
										<Dropdown.Menu>
											<button className='dropdown-item'><BiCommentEdit /> Create</button>
											<button className='dropdown-item'><TbEye /> Exists</button>
										</Dropdown.Menu>
									</Dropdown>
								)
							}
					...
					data={[
						{date: "13th Aug 2022", saas_org: "Brighter Monday", requestor: "Amin Sis", sub_service: "Identity", country: "Ivory Coast", document_data_required: "Copy of National Identity Card",},
						{date: "24th May 2022", saas_org: "Darubini", requestor: "Cheq Mamo", sub_service: "Credit", country: "Tunisia", document_data_required: "Copy of National Identity Card",},
					]}
					options={{
...
export default SubServicesRequests
