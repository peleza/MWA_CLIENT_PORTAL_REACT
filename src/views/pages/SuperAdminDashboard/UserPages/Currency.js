	...
	return (
		<>
			<section className='dashboard-section pidvaDashboard'>
				<h1 className='dashboard-title'> Currency </h1>
				...
				<MaterialTable
					...
					columns={[
						...
						{
							title: 'Currency Name', field: 'currency_name',
							render: (rowData) => {
								return (
									<>
										<span><img src={rowData.currency_icon} width={30} alt="flag" /> {rowData.currency_name}</span>
									</>
								)
							}
						},
						{ title: 'Code', field: 'currency_code' },
					...
					data={[
						{ currency_name: "US Dollar", currency_icon: "/images/local-internation-data-icon.svg", currency_code: "AGCT", created_by: "Christy Yen", createdAt: "2022-07-22T10:09:45.834Z", status: 1, },
						{ currency_name: "Kenya Shillings", currency_icon: "/images/local-internation-data-icon.svg", currency_code: "AGCT", created_by: "Christy Yen", createdAt: "2022-07-22T10:09:45.834Z", status: 1, },
						{ currency_name: "Naira", currency_icon: "/images/local-internation-data-icon.svg", currency_code: "AGCT", created_by: "Christy Yen", createdAt: "2022-07-22T10:09:45.834Z", status: 1, },
					]}
					options={{
				...
				<Modal.Body className='pb-0'>
					<Form onSubmit={addCountry} autoComplete="false">
						...
						<FileUpload
							...
							labelText="Upload Currency Icon"
							onChange={getFileName}
							name="comp_incop_certif_url"
							accept='Jpeg, PNG, PDF'
							error="Please Upload Currency Icon!"
						/>
